<?php /* Smarty version Smarty-3.1.7, created on 2015-05-07 11:47:45
         compiled from "C:\work\Dropbox\dealerportal\includes\runtime/../../layouts/vlayout\modules\Inventory\EditViewBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9497552acff5dd3886-99876453%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6c433e7bae3929cf309ae8253c47042128378390' => 
    array (
      0 => 'C:\\work\\Dropbox\\dealerportal\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\EditViewBlocks.tpl',
      1 => 1430999247,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9497552acff5dd3886-99876453',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_552acff70dd6d',
  'variables' => 
  array (
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_552acff70dd6d')) {function content_552acff70dd6d($_smarty_tpl) {?>
...
" name="copyAddress1"><label class="radio pull-left"><input type="radio" name="copyAddressFromRight" class="accountAddress" data-copy-address="billing" checked=""><?php echo vtranslate('SINGLE_Accounts',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><label class="radio pull-left"><input type="radio" name="copyAddressFromRight" class="contactAddress" data-copy-address="billing" checked=""><?php echo vtranslate('SINGLE_Contacts',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><label class="radio pull-left"><input type="radio" name="copyAddressFromRight" class="shippingAddress" data-target="shipping" checked=""><?php echo vtranslate('Shipping Address',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><label class="radio pull-left hide"><input type="radio" name="copyAddressFromRight"  class="billingAddress" data-target="billing" checked=""><?php echo vtranslate('Billing Address',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></td><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
" name="copyAddress2"><label class="radio pull-left"><input type="radio" name="copyAddressFromLeft" class="accountAddress" data-copy-address="shipping" checked=""><?php echo vtranslate('SINGLE_Accounts',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><label class="radio pull-left"><input type="radio" name="copyAddressFromLeft" class="contactAddress" data-copy-address="shipping" checked=""><?php echo vtranslate('SINGLE_Contacts',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><label class="radio pull-left"><input type="radio" name="copyAddressFromLeft" class="billingAddress" data-target="billing" checked=""><?php echo vtranslate('Billing Address',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><label class="radio pull-left hide"><input type="radio" name="copyAddressFromLeft" class="shippingAddress" data-target="shipping" checked=""><?php echo vtranslate('Shipping Address',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></td></tr><?php }?><tr><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
