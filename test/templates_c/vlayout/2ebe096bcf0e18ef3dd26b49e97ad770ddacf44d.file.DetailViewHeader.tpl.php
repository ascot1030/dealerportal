<?php /* Smarty version Smarty-3.1.7, created on 2015-05-21 02:29:56
         compiled from "C:\work\Dropbox\dealerportal\includes\runtime/../../layouts/vlayout\modules\Vtiger\DetailViewHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22755502417cd45928-64401855%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ebe096bcf0e18ef3dd26b49e97ad770ddacf44d' => 
    array (
      0 => 'C:\\work\\Dropbox\\dealerportal\\includes\\runtime/../../layouts/vlayout\\modules\\Vtiger\\DetailViewHeader.tpl',
      1 => 1432173563,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22755502417cd45928-64401855',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5502417d7196f',
  'variables' => 
  array (
    'MODULE_MODEL' => 0,
    'RECORD' => 0,
...
<?php if ($_valid && !is_callable('content_5502417d7196f')) {function content_5502417d7196f($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()==''){?><li class="divider"></li><?php }elseif($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()=="Export to PDF"){?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
...
&action=CreatePDFFromTemplate&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
...
&action=CreatePDFFromTemplate&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
&language='+document.getElementById('template_language').value;"><?php echo vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></li><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=="SalesOrder"&&$_smarty_tpl->tpl_vars['DEPTH']->value<4){?><li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
_detailView_moreAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel());?>
"><a href="javascript:;" onclick="if((navigator.userAgent.match(/iPad/i)!= null)||(navigator.userAgent.match(/iPhone/i)!= null)||(navigator.userAgent.match(/iPod/i)!= null)) window.open('index.php?module=PDFMaker&relmodule=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
&action=CreatePDFFromTemplate&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
&purchase=1&language='+document.getElementById('template_language').value); else document.location.href='index.php?module=PDFMaker&relmodule=<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
&action=CreatePDFFromTemplate&record=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
&purchase=1&language='+document.getElementById('template_language').value;"><?php echo vtranslate('LBL_EXPORT_TO_PURCHASE_ORDER',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></li><?php }?><?php }elseif($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()=="Send Email with PDF"){?><!--li id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
_detailView_moreAction_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel());?>
...
"><a href=<?php echo $_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getUrl();?>
 ><?php echo vtranslate($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></li><?php }?><?php } ?></ul></span><?php }?></div></div></div></div></div><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['NO_PAGINATION']->value;?>
