<?php /* Smarty version Smarty-3.1.7, created on 2015-05-19 13:05:55
         compiled from "C:\work\Dropbox\dealerportal\includes\runtime/../../layouts/vlayout\modules\Vtiger\MenuBar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:141125501e0ca51ece5-00523017%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47da4eecb2e5e369c939c108ad82c2a48ee929e6' => 
    array (
      0 => 'C:\\work\\Dropbox\\dealerportal\\includes\\runtime/../../layouts/vlayout\\modules\\Vtiger\\MenuBar.tpl',
      1 => 1432040690,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '141125501e0ca51ece5-00523017',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5501e0cc038c7',
  'variables' => 
  array (
    'MENU_STRUCTURE' => 0,
    'moreMenus' => 0,
...
<?php if ($_valid && !is_callable('content_5501e0cc038c7')) {function content_5501e0cc038c7($_smarty_tpl) {?>
...
?><?php if ($_smarty_tpl->tpl_vars['moduleList']->value){?><?php if ($_smarty_tpl->tpl_vars['parent']->value!="TOOLS"){?><strong><?php echo vtranslate("LBL_".($_smarty_tpl->tpl_vars['parent']->value),$_smarty_tpl->tpl_vars['moduleName']->value);?>
...
</a></label><?php } ?><?php }?><?php }?><?php } ?></div></div></li></ul><ul class="nav modulesList" id="mediumNav"><li class="tabs"><a class="alignMiddle <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Home'){?> selected <?php }?>" href="<?php echo $_smarty_tpl->tpl_vars['HOME_MODULE_MODEL']->value->getDefaultUrl();?>
"><img src="<?php echo vimage_path('home.png');?>
" alt="<?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['moduleName']->value);?>
" title="<?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['moduleName']->value);?>
...
" href="<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getDefaultUrl();?>
" <?php if ($_smarty_tpl->tpl_vars['MODULE']->value==$_smarty_tpl->tpl_vars['moduleName']->value){?> class="selected" <?php }?>><strong><?php echo $_smarty_tpl->tpl_vars['translatedModuleLabel']->value;?>
</strong></a></li><?php } ?></ul><?php if ($_smarty_tpl->tpl_vars['SESSION_DEPTH']->value<2){?><ul class="nav" id="commonMoreMenu"><li class="dropdown" id="moreMenu"><a class="dropdown-toggle" data-toggle="dropdown" href="#moreMenu"><strong><?php echo vtranslate('LBL_ALL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" href="<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getDefaultUrl();?>
"><?php echo $_smarty_tpl->tpl_vars['translatedModuleLabel']->value;?>
</a></label><?php } ?></span><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['more']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['more']['index']+1)%4==0){?></div><?php }?><?php } ?></div></li></ul><?php }?></div><div class="span3 marginLeftZero pull-right" id="headerLinks"><span id="headerLinksBig" class="pull-right headerLinksContainer"><!--span class="dropdown span settingIcons"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="<?php echo vimage_path('theme_brush.png');?>
...
;"></div><?php } ?></div></div><div id="progressDiv"></div></ul></span--><?php $_smarty_tpl->tpl_vars["menuIndex"] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['obj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['obj']->_loop = false;
...
</strong>&nbsp;<i class="caret"></i> </a> </span><?php }?><?php if (!empty($_smarty_tpl->tpl_vars['childLinks']->value)){?><ul class="dropdown-menu pull-right"><?php $_smarty_tpl->tpl_vars["subIndex"] = new Smarty_variable(0, null, 0);?><?php  $_smarty_tpl->tpl_vars['obj'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['obj']->_loop = false;
 $_smarty_tpl->tpl_vars['index'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['childLinks']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['obj']->key => $_smarty_tpl->tpl_vars['obj']->value){
$_smarty_tpl->tpl_vars['obj']->_loop = true;
 $_smarty_tpl->tpl_vars['index']->value = $_smarty_tpl->tpl_vars['obj']->key;
?><?php if (Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['obj']->value->getLabel())=="LBL_CRM_SETTINGS"&&$_smarty_tpl->tpl_vars['USER_MODEL']->value->get('last_name')!="systemadmin"){?><?php $_smarty_tpl->tpl_vars["subIndex"] = new Smarty_variable(1, null, 0);?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['obj']->value->getLabel()==null&&$_smarty_tpl->tpl_vars['subIndex']->value==0){?><li class="divider">&nbsp;</li><?php }elseif($_smarty_tpl->tpl_vars['obj']->value->getLabel()!=null){?><?php $_smarty_tpl->tpl_vars["id"] = new Smarty_variable($_smarty_tpl->tpl_vars['obj']->value->getId(), null, 0);?><?php $_smarty_tpl->tpl_vars["href"] = new Smarty_variable($_smarty_tpl->tpl_vars['obj']->value->getUrl(), null, 0);?><?php $_smarty_tpl->tpl_vars["label"] = new Smarty_variable($_smarty_tpl->tpl_vars['obj']->value->getLabel(), null, 0);?><?php $_smarty_tpl->tpl_vars["onclick"] = new Smarty_variable('', null, 0);?><?php if (stripos($_smarty_tpl->tpl_vars['obj']->value->getUrl(),'javascript:')===0){?><?php $_smarty_tpl->tpl_vars["onclick"] = new Smarty_variable(("onclick=").($_smarty_tpl->tpl_vars['href']->value), null, 0);?><?php $_smarty_tpl->tpl_vars["href"] = new Smarty_variable("javascript:;", null, 0);?><?php }?><li><a target="<?php echo $_smarty_tpl->tpl_vars['obj']->value->target;?>
...
</a></li><?php }?><?php }?><?php } ?></ul><?php }?></span><?php }?><?php $_smarty_tpl->tpl_vars["menuIndex"] = new Smarty_variable($_smarty_tpl->tpl_vars['menuIndex']->value+1, null, 0);?><?php } ?></span><div id="headerLinksCompact"><span class="btn-group dropdown qCreate cursorPointer"><img src="<?php echo vimage_path('btnAdd_white.png');?>
