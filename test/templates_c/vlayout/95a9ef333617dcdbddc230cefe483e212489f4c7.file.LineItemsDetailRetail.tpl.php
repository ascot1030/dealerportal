<?php /* Smarty version Smarty-3.1.7, created on 2015-05-14 18:13:09
         compiled from "C:\work\Dropbox\dealerportal\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsDetailRetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:796455473588c12c48-98210981%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95a9ef333617dcdbddc230cefe483e212489f4c7' => 
    array (
      0 => 'C:\\work\\Dropbox\\dealerportal\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\LineItemsDetailRetail.tpl',
      1 => 1431607720,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '796455473588c12c48-98210981',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5547358aa5652',
  'variables' => 
  array (
    'RELATED_PRODUCTS' => 0,
    'MODULE_NAME' => 0,
...
<?php if ($_valid && !is_callable('content_5547358aa5652')) {function content_5547358aa5652($_smarty_tpl) {?>
...
<!--/a--></b>
        ...
        <tr>
            ...
            <td>
                <b><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["retail_taxes"][0]["percentage"]*1000/1000;?>
%</b>
            </td>
            <td colspan="6">
                <span class="pull-right">
...
<?php }else{ ?>0.00<?php }?></b></span>
	...
	<table class="table table-bordered hide">
		...
		<td width="83%">
		    <span class="pull-right">
			<?php ob_start();?><?php echo vtranslate('LBL_FINAL_DISCOUNT_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp11=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['discount_type_final']=='percentage'){?><?php echo " ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['discount_percentage_final'];?><?php echo " % ";?><?php echo vtranslate('LBL_OF',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
"><?php echo vtranslate('LBL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
		...
		<tr>
			...
			<span class="pull-right">
			    <?php ob_start();?><?php echo vtranslate('LBL_TOTAL_AFTER_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp13=ob_get_clean();?><?php ob_start();?><?php  $_smarty_tpl->tpl_vars['tax_details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax_details']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["taxes"]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['tax_details']->key => $_smarty_tpl->tpl_vars['tax_details']->value){
$_smarty_tpl->tpl_vars['tax_details']->_loop = true;
?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["taxlabel"];?><?php echo " : ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["percentage"];?><?php echo " % = ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["amount"];?><?php echo "\r\n";?><?php } ?><?php $_tmp14=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_TOTAL_TAX_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp15=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['GROUP_TAX_INFO'] = new Smarty_variable($_tmp13." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["totalAfterDiscount"])."\r\n".$_tmp14."\r\n".$_tmp15." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['tax_totalamount']), null, 0);?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['tax_details']->key => $_smarty_tpl->tpl_vars['tax_details']->value){
$_smarty_tpl->tpl_vars['tax_details']->_loop = true;
?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["taxlabel"];?><?php echo " : ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["percentage"];?><?php echo " % = ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["amount"];?><?php echo "\r\n";?><?php } ?><?php $_tmp17=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_TOTAL_TAX_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp18=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['SHIPPING_HANDLING_TAX_INFO'] = new Smarty_variable($_tmp16." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["shipping_handling_charge"])."\r\n".$_tmp17."\r\n".$_tmp18." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['shtax_totalamount']), null, 0);?>
...
'>
	...
	<table class="table table-bordered hide">
		...
		<td width="83%">
		    <span class="pull-right">
			<?php ob_start();?><?php echo vtranslate('LBL_FINAL_DISCOUNT_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp19=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['retail_discount_type_final']=='percentage'){?><?php echo " ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['retail_discount_percentage_final'];?><?php echo " % ";?><?php echo vtranslate('LBL_OF',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php echo " ";?><?php echo $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['retail_hdnSubTotal'];?><?php echo " = ";?><?php }?><?php $_tmp20=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['FINAL_DISCOUNT_INFO'] = new Smarty_variable($_tmp19." = ".$_tmp20.($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['retail_discountTotal_final']), null, 0);?>
			(-)&nbsp;<b><a class="inventoryLineItemDetails" href="javascript:void(0)" id="finalDiscount" data-info="<?php echo $_smarty_tpl->tpl_vars['FINAL_DISCOUNT_INFO']->value;?>
"><?php echo vtranslate('LBL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></b>
		    </span>
		...
		<tr>
			...
			<span class="pull-right">
			    <?php ob_start();?><?php echo vtranslate('LBL_TOTAL_AFTER_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp21=ob_get_clean();?><?php ob_start();?><?php  $_smarty_tpl->tpl_vars['tax_details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax_details']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["retail_taxes"]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['tax_details']->key => $_smarty_tpl->tpl_vars['tax_details']->value){
$_smarty_tpl->tpl_vars['tax_details']->_loop = true;
?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["taxlabel"];?><?php echo " : ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["percentage"];?><?php echo " % = ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["amount"];?><?php echo "\r\n";?><?php } ?><?php $_tmp22=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_TOTAL_TAX_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp23=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['GROUP_TAX_INFO'] = new Smarty_variable($_tmp21." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["retail_totalAfterDiscount"])."\r\n".$_tmp22."\r\n".$_tmp23." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['retail_tax_totalamount']), null, 0);?>
			    (+)&nbsp;<b><a class="inventoryLineItemDetails" href="javascript:void(0)" id="finalTax"
					   data-info='<?php echo $_smarty_tpl->tpl_vars['GROUP_TAX_INFO']->value;?>
'><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a></b>
		...
		<td width="83%">
		    <span class="pull-right">
			<?php ob_start();?><?php echo vtranslate('LBL_SHIPPING_AND_HANDLING_CHARGES',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp24=ob_get_clean();?><?php ob_start();?><?php  $_smarty_tpl->tpl_vars['tax_details'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax_details']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["retail_sh_taxes"]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['tax_details']->key => $_smarty_tpl->tpl_vars['tax_details']->value){
$_smarty_tpl->tpl_vars['tax_details']->_loop = true;
?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["taxlabel"];?><?php echo " : ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["percentage"];?><?php echo " % = ";?><?php echo $_smarty_tpl->tpl_vars['tax_details']->value["amount"];?><?php echo "\r\n";?><?php } ?><?php $_tmp25=ob_get_clean();?><?php ob_start();?><?php echo vtranslate('LBL_TOTAL_TAX_AMOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
<?php $_tmp26=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['SHIPPING_HANDLING_TAX_INFO'] = new Smarty_variable($_tmp24." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["retail_shipping_handling_charge"])."\r\n".$_tmp25."\r\n".$_tmp26." = ".($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['retail_shtax_totalamount']), null, 0);?>
			(+)&nbsp;<b><a class="inventoryLineItemDetails" href="javascript:void(0)" id="shippingHandlingTax"
				       data-info='<?php echo $_smarty_tpl->tpl_vars['SHIPPING_HANDLING_TAX_INFO']->value;?>
'>
				<?php echo vtranslate('LBL_TAX_FOR_SHIPPING_AND_HANDLING',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
