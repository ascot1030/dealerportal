<?php /* Smarty version Smarty-3.1.7, created on 2015-05-14 09:22:51
         compiled from "C:\work\Dropbox\dealerportal\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6622552acff738f408-59479602%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56426062dff0d277ece262b2a83d621aa2391ae5' => 
    array (
      0 => 'C:\\work\\Dropbox\\dealerportal\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\LineItemsEdit.tpl',
      1 => 1431595263,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6622552acff738f408-59479602',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_552acff8b3f10',
  'variables' => 
  array (
    'RELATED_PRODUCTS' => 0,
    'FINAL' => 0,
...
<?php if ($_valid && !is_callable('content_552acff8b3f10')) {function content_552acff8b3f10($_smarty_tpl) {?>
...
" /><table class="table table-bordered blockContainer lineItemTable" id="lineItemTab"><tr><?php if (1){?><th colspan="11"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_ITEM_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span></th><th colspan="4" class="hide"><div class="row-fluid"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_MARGIN',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</b></td><td class="hide"><b class="pull-right"><?php echo vtranslate('LBL_RETAIL_LIST_PRICE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</b></td><td class="hide"><b class="pull-right"><?php echo vtranslate('LBL_ITEM_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</b></td><td class="hide"><b class="pull-right"><?php echo vtranslate('LBL_RETAIL_NET_PRICE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
" /><input type="hidden" name="subtotal" id="subtotal" value="" /><input type="hidden" name="total" id="total" value="" /><table class="table table-bordered blockContainer lineItemTable hide" id="retail_lineItemResult"><tr><td  width="83%"><div class="pull-right"><strong><?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
