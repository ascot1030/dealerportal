<?php /* Smarty version Smarty-3.1.7, created on 2015-05-14 09:48:17
         compiled from "C:\work\Dropbox\dealerportal\includes\runtime/../../layouts/vlayout\modules\Inventory\LineItemsEditAll.tpl" */ ?>
<?php /*%%SmartyHeaderCode:148335547336b64b282-43447556%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c284e1a91130fa12cc490a3d704b020da101211b' => 
    array (
      0 => 'C:\\work\\Dropbox\\dealerportal\\includes\\runtime/../../layouts/vlayout\\modules\\Inventory\\LineItemsEditAll.tpl',
      1 => 1431592656,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '148335547336b64b282-43447556',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5547336de99ac',
  'variables' => 
  array (
    'RELATED_PRODUCTS' => 0,
    'FINAL' => 0,
...
<?php if ($_valid && !is_callable('content_5547336de99ac')) {function content_5547336de99ac($_smarty_tpl) {?>
...
" /><table class="table table-bordered blockContainer lineItemTable" id="lineItemTab"><tr><?php if (1){?><th colspan="10"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_ITEM_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</b></td></tr><tr id="row0" class="hide lineItemCloneCopy"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsContentAll.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>0,'data'=>array()), 0);?>
...
<?php }?>><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsContentAll.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>$_smarty_tpl->tpl_vars['row_no']->value,'data'=>$_smarty_tpl->tpl_vars['data']->value), 0);?>
</tr><?php } ?><?php if (count($_smarty_tpl->tpl_vars['RELATED_PRODUCTS']->value)==0){?><tr id="row1" class="lineItemRow"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsContentAll.tpl",'Inventory'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>1,'data'=>array()), 0);?>
...
" /><input type="hidden" name="subtotal" id="subtotal" value="" /><input type="hidden" name="total" id="total" value="" /><table class="table table-bordered blockContainer lineItemTable" id="retail_lineItemResult"><tr><td  width="83%"><div class="pull-right"><strong>Retail <?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0.00<?php }?></div></td></tr><tr><td width="83%"><span class="pull-right">(-)&nbsp;<b><a href="javascript:void(0)"  id="retail_finalDiscount">Retail <?php echo vtranslate('LBL_INVOICE_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></div></div><!-- End Popup Div --></td></tr><tr><td width="83%"><span class="pull-right">(+)&nbsp;<b>Retail <?php echo vtranslate('LBL_SHIPPING_AND_HANDLING_CHARGES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0.00<?php }?>" /></span></td></tr><tr><td width="83%"><span class="pull-right"><b>Retail <?php echo vtranslate('LBL_PRE_TAX_TOTAL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
%</b></span><span class="pull-right">(+)&nbsp;<b><!--a href="javascript:void(0)" id="retail_finalTax"-->Retail <?php echo vtranslate('LBL_GST',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0.00<?php }?></span></td></tr><!-- Group Tax - ends --><tr class="hide"><td width="83%"><span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="retail_shippingHandlingTax">Retail <?php echo vtranslate('LBL_TAX_FOR_SHIPPING_AND_HANDLING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0.00<?php }?></span></td></tr><tr valign="top" class="hide"><td width="83%" ><div class="pull-right"><b>Retail <?php echo vtranslate('LBL_ADJUSTMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0.00<?php }?>"/><span class="pull-right"><b>Retail <?php echo vtranslate('LBL_GRAND_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
