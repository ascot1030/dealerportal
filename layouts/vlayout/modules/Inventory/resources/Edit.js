...
Vtiger_Edit_Js("Inventory_Edit_Js",{
    ...
    lineItemRetailResultContainer : false,
    ...
    getRetailLineItemResultContainer : function(){
        if(this.lineItemRetailResultContainer == false) {
            this.setRetailLinteItemResultContainer(jQuery('#retail_lineItemResult'));
        }
        return this.lineItemRetailResultContainer;
    },
    ...
    setRetailLinteItemResultContainer : function(element) {
        this.lineItemRetailResultContainer = element;
        return this;
    },
    ...
    getMarginElement : function() {
        return jQuery('#retail_margin');
    },

    getMarginValue : function() {
        return parseFloat(jQuery('.retail_margin').val());
    },
    ...
    getRetailShippingAndHandlingControlElement : function(){
        return jQuery('#retail_shipping_handling_charge');
    },
    ...
    getRetailAdjustmentTypeElement : function() {
        return jQuery('input:radio[name="retail_adjustmentType"]');
    },
    ...
    getRetailAdjustmentTextElement : function(){
        return jQuery('#retail_adjustment');
    },
    ...
    getRetailTaxTypeSelectElement : function(){
        return jQuery('#taxtype'); //jin retail_taxtype
    },
    ...
    isRetailIndividualTaxMode : function() {
        var taxTypeElement = this.getRetailTaxTypeSelectElement();
        var selectedOption = taxTypeElement.find('option:selected');
        if(selectedOption.val() == Inventory_Edit_Js.individualTaxType){
            return true;
        }
    ...
    getRetailListPriceValue : function(lineItemRow) {
        return parseFloat(jQuery('.retail_listPrice',lineItemRow).val());
    },
    ...
    setRetailListPriceValue : function(lineItemRow, listPriceValue) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var listPrice = parseFloat(listPriceValue).toFixed(numberOfDecimal);
        lineItemRow.find('.retail_listPrice').val(listPrice);
        return this;
    },
    ...
    setLineItemTotal : function(lineItemRow, lineItemTotalValue) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        lineItemTotalValue = parseFloat(lineItemTotalValue).toFixed(numberOfDecimal);
        jQuery('.productTotal', lineItemRow).text(lineItemTotalValue);
        return this;
    },

    setRetailLineItemTotal : function(lineItemRow, lineItemTotalValue) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        lineItemTotalValue = parseFloat(lineItemTotalValue).toFixed(numberOfDecimal);
        jQuery('.retail_productTotal', lineItemRow).text(lineItemTotalValue);
        return this;
    },
    ...
    getRetailLineItemTotal : function(lineItemRow) {
        return parseFloat(this.getRetailLineItemTotalElement(lineItemRow).text());
    },
    ...
    getRetailLineItemTotalElement : function(lineItemRow) {
        return jQuery('.retail_productTotal', lineItemRow);
    },
    ...
    setDiscountTotal : function(lineItemRow, discountValue) {
        ...
        this.setShowDiscountTotal(lineItemRow, discountValue);
        return this;
    },

    setShowDiscountTotal : function(lineItemRow, discountValue) {
//        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
//        discountValue = parseFloat(discountValue).toFixed(numberOfDecimal);
//        jQuery('.showDiscountTotal',lineItemRow).text(discountValue);
//        return this;
...
//            discountValue = (productTotal * discountValue)/100;
    ...
    setRetailDiscountTotal : function(lineItemRow, discountValue) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        discountValue = parseFloat(discountValue).toFixed(numberOfDecimal);
        jQuery('.retail_discountTotal',lineItemRow).text(discountValue);
        this.setShowRetailDiscountTotal(lineItemRow, discountValue);
        return this;
    },

    setShowRetailDiscountTotal : function(lineItemRow, discountValue) {
        var discountContianer = lineItemRow.find('div.retail_discountUI');
        var element = discountContianer.find('input.retail_discounts').filter(':checked');
        var discountType = element.data('discountType');
        var discountRow = element.closest('tr');

        jQuery('input.retail_discount_type',discountContianer).val(discountType);


        var discountValue = discountRow.find('.retail_discountVal').val();
        if(discountValue == ""){
            discountValue = 0;
        }
        if(isNaN(discountValue) ||  discountValue < 0){
        ...
        jQuery('.retail_showDiscountTotal',lineItemRow).text(discountValue);
    },
    /**
    ...
    getRetailDiscountTotal : function(lineItemRow) {
        return parseFloat(jQuery('.retail_discountTotal',lineItemRow).text());
    },
    /**
    ...
    setTotalAfterDiscount : function(lineItemRow, totalAfterDiscountValue){
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        totalAfterDiscountValue = parseFloat(totalAfterDiscountValue).toFixed(numberOfDecimal);
        jQuery('.totalAfterDiscount',lineItemRow).text(totalAfterDiscountValue);
        return this;
    },

    setRetailTotalAfterDiscount : function(lineItemRow, totalAfterDiscountValue){
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        totalAfterDiscountValue = parseFloat(totalAfterDiscountValue).toFixed(numberOfDecimal);
        jQuery('.retail_totalAfterDiscount',lineItemRow).text(totalAfterDiscountValue);
        return this;
    },
    ...
    getRetailTotalAfterDiscount : function(lineItemRow) {
        return parseFloat(jQuery('.retail_totalAfterDiscount',lineItemRow).text());
    },
    /**
    ...
    setRetailLineItemTaxTotal : function(lineItemRow, taxTotal) {
        jQuery('.retail_productTaxTotal', lineItemRow).text(taxTotal);
        return this;
    },
    ...
    getRetailLineItemTaxTotal : function(lineItemRow){
        return parseFloat(jQuery('.retail_productTaxTotal', lineItemRow).text());
    },
    ...
    setRetailLineItemNetPrice : function(lineItemRow, lineItemNetPriceValue){
        jQuery('.retail_netPrice',lineItemRow).text(lineItemNetPriceValue);
        return this;
    },
    ...
    getRetailLineItemNetPrice : function(lineItemRow) {
        return parseFloat(jQuery('.retail_netPrice',lineItemRow).text());
    },

    setLineItemWhlPrice : function(lineItemRow, lineItemWhlPriceValue){
        jQuery('.wholesalePrice',lineItemRow).text(lineItemWhlPriceValue);
        jQuery('input.wholesalePrice',lineItemRow).val(lineItemWhlPriceValue);
        return this;
    },

    getLineItemWhlPrice : function(lineItemRow) {
        return parseFloat(jQuery('.wholesalePrice',lineItemRow).text());
    },

    setNetTotal : function(netTotalValue){
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        netTotalValue = parseFloat(netTotalValue).toFixed(numberOfDecimal);
        jQuery('#netTotal').text(netTotalValue);
        return this;
    },

    setRetailNetTotal : function(netTotalValue){
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        netTotalValue = parseFloat(netTotalValue).toFixed(numberOfDecimal);
        jQuery('#retail_netTotal').text(netTotalValue);
        return this;
    },
    ...
    getRetailNetTotal : function() {
        return parseFloat(jQuery('#retail_netTotal').text());
    },
    ...
    setRetailFinalDiscountTotal : function(finalDiscountValue){
        jQuery('#retail_discountTotal_final').text(finalDiscountValue);
        return this;
    },
    ...
    getRetailFinalDiscountTotal : function() {
        return parseFloat(jQuery('#retail_discountTotal_final').text());
    },
    ...
    setRetailGroupTaxTotal : function(groupTaxTotalValue) {
        jQuery('#retail_tax_final').text(groupTaxTotalValue);
    },

    setShowGroupTaxTotal : function(groupTaxTotalValue) {
        jQuery('#show_tax_final').text(groupTaxTotalValue);
    },

    setRetailShowGroupTaxTotal : function(groupTaxTotalValue) {
        jQuery('#retail_show_tax_final').text(groupTaxTotalValue);
    },
    ...
    getRetailGroupTaxTotal : function() {
        return parseFloat(jQuery('#retail_tax_final').text());
    },
    ...
    getRetailShippingAndHandling : function() {
        return parseFloat(this.getRetailShippingAndHandlingControlElement().val());
    },
    ...
    setRetailShippingAndHandlingTaxTotal : function() {
        var shippingTotal = jQuery('.retail_shippingTaxTotal');
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var shippingFinalTaxTotal = 0;
        jQuery.each(shippingTotal,function(index,domElement){
            var totalVal = parseFloat(jQuery(domElement).val());
        ...
        shippingFinalTaxTotal = shippingFinalTaxTotal.toFixed(numberOfDecimal);
        jQuery('#retail_shipping_handling_tax').text(shippingFinalTaxTotal);
        return this;
    },
    ...
    getRetailShippingAndHandlingTaxTotal : function() {
        return parseFloat(jQuery('#retail_shipping_handling_tax').text());
    },
    ...
    getRetailAdjustmentValue : function() {
        return parseFloat(this.getRetailAdjustmentTextElement().val());
    },
    ...
    isRetailAdjustMentAddType : function() {
        var adjustmentSelectElement = this.getRetailAdjustmentTypeElement();
        var selectionOption;
        adjustmentSelectElement.each(function(){
            if(jQuery(this).is(':checked')){
                selectionOption = jQuery(this);
    ...
    isRetailAdjustMentDeductType : function() {
        var adjustmentSelectElement = this.getRetailAdjustmentTypeElement();
        var selectionOption;
        adjustmentSelectElement.each(function(){
            if(jQuery(this).is(':checked')){
    ...
    setActualDiscount : function(actualDiscountValue) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        actualDiscountValue = parseFloat(actualDiscountValue).toFixed(numberOfDecimal);
        jQuery('#actualDiscount').text(actualDiscountValue);
        return this;
    },

    setRetailActualDiscount : function(actualDiscountValue) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        actualDiscountValue = parseFloat(actualDiscountValue).toFixed(numberOfDecimal);
        jQuery('#retail_actualDiscount').text(actualDiscountValue);
        jQuery('#retail_actual_discount').val(actualDiscountValue);

        return this;
    },

    setRetailActualMargin : function(actualMarginValue) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        actualMarginValue = parseFloat(actualMarginValue).toFixed(numberOfDecimal);
        jQuery('#retail_actualMargin').text(actualMarginValue);
        jQuery('#retail_actual_margin').val(actualMarginValue);
    ...
    setRetailGrandTotal : function(grandTotalValue) {
        jQuery('#retail_grandTotal').text(grandTotalValue);
        return this;
    },
    ...
    getRetailGrandTotal : function() {
        return parseFloat(jQuery('#retail_grandTotal').text());
    },
    ...
    mapResultsToFields: function(referenceModule,element,responseData){
        ...
        var lineItemImgElment = jQuery('img.lineItemPopup',parentRow);
        ...
        for(var id in responseData){
            ...
            jQuery('input.qty',parentRow).val(recordData.quantity);
            jQuery('input.productwidth',parentRow).val(recordData.productwidth);
            jQuery('.productwidth',parentRow).text(recordData.productwidth);
            jQuery('input.productdrop',parentRow).val(recordData.productdrop);
            jQuery('.productdrop',parentRow).text(recordData.productdrop);
            jQuery('input.fabric',parentRow).val(recordData.fabric);
            jQuery('.fabric',parentRow).text(recordData.fabric);
            jQuery('input.location',parentRow).val(recordData.location);
            jQuery('.location',parentRow).text(recordData.location);
            jQuery('input.fabric_description',parentRow).val(recordData.fabric_description);
            jQuery('.fabric_description',parentRow).text(recordData.fabric_description);

            jQuery('input.controltype',parentRow).val(recordData.controltype);
            jQuery('input.rolldirection',parentRow).val(recordData.rolldirection);
            jQuery('input.bottomrail',parentRow).val(recordData.bottomrail);
            jQuery('input.railcolour',parentRow).val(recordData.railcolour);
            jQuery('input.controlside',parentRow).val(recordData.controlside);
            jQuery('input.controlcolour',parentRow).val(recordData.controlcolour);
            jQuery('input.chaincolour',parentRow).val(recordData.chaincolour);
            jQuery('input.chainlength',parentRow).val(recordData.chainlength);
            jQuery('input.springassist',parentRow).val(recordData.springassist);
            jQuery('input.bracketcovers',parentRow).val(recordData.bracketcovers);
            jQuery('input.railroad',parentRow).val(recordData.railroad);
            jQuery('input.comments',parentRow).val(recordData.comments);
...
//			lineItemNameElment.attr('disabled', 'disabled');
            ...
            lineItemNameElment.data('location', recordData.location);
            lineItemNameElment.data('quantity', recordData.quantity);
            lineItemNameElment.data('productwidth', recordData.productwidth);
            lineItemNameElment.data('productdrop', recordData.productdrop);
            lineItemNameElment.data('controltype', recordData.controltype);
            lineItemNameElment.data('fabric', recordData.fabric);
            lineItemNameElment.data('rolldirection', recordData.rolldirection);
            lineItemNameElment.data('bottomrail', recordData.bottomrail);
            lineItemNameElment.data('railcolour', recordData.railcolour);
            lineItemNameElment.data('controlside', recordData.controlside);
            lineItemNameElment.data('controlcolour', recordData.controlcolour);
            lineItemNameElment.data('chaincolour', recordData.chaincolour);
            lineItemNameElment.data('chainlength', recordData.chainlength);
            lineItemNameElment.data('springassist', recordData.springassist);
            lineItemNameElment.data('bracketcovers', recordData.bracketcovers);
            lineItemNameElment.data('railroad', recordData.railroad);
            lineItemNameElment.data('comments', recordData.comments);

            lineItemImgElment.data('location', recordData.location);
            lineItemImgElment.data('quantity', recordData.quantity);
            lineItemImgElment.data('productwidth', recordData.productwidth);
            lineItemImgElment.data('productdrop', recordData.productdrop);
            lineItemImgElment.data('controltype', recordData.controltype);
            lineItemImgElment.data('fabric', recordData.fabric);
            lineItemImgElment.data('rolldirection', recordData.rolldirection);
            lineItemImgElment.data('bottomrail', recordData.bottomrail);
            lineItemImgElment.data('railcolour', recordData.railcolour);
            lineItemImgElment.data('controlside', recordData.controlside);
            lineItemImgElment.data('controlcolour', recordData.controlcolour);
            lineItemImgElment.data('chaincolour', recordData.chaincolour);
            lineItemImgElment.data('chainlength', recordData.chainlength);
            lineItemImgElment.data('springassist', recordData.springassist);
            lineItemImgElment.data('bracketcovers', recordData.bracketcovers);
            lineItemImgElment.data('railroad', recordData.railroad);
            lineItemImgElment.data('comments', recordData.comments);
    ...
    lineItemPopupEventHandler : function(popupImageElement) {
        ...
        params.record = popupImageElement.data('record');
        params.id = popupImageElement.data('id');

        params.location = popupImageElement.data('location');
        params.quantity = popupImageElement.data('quantity');
        params.productwidth = popupImageElement.data('productwidth');
        params.productdrop = popupImageElement.data('productdrop');
        params.controltype = popupImageElement.data('controltype');
        params.fabric = popupImageElement.data('fabric');
        params.rolldirection = popupImageElement.data('rolldirection');
        params.bottomrail = popupImageElement.data('bottomrail');
        params.railcolour = popupImageElement.data('railcolour');
        params.controlside = popupImageElement.data('controlside');
        params.controlcolour = popupImageElement.data('controlcolour');
        params.chaincolour = popupImageElement.data('chaincolour');
        params.chainlength = popupImageElement.data('chainlength');
        params.springassist = popupImageElement.data('springassist');
        params.bracketcovers = popupImageElement.data('bracketcovers');
        params.railroad = popupImageElement.data('railroad');
        params.comments = popupImageElement.data('comments');
    ...
    calculateRetailLineItemTotal : function (lineItemRow) {
        var quantity = this.getQuantityValue(lineItemRow);
        var listPrice = this.getRetailListPriceValue(lineItemRow);
        var lineItemTotal = parseFloat(quantity) * parseFloat(listPrice);
        this.setRetailLineItemTotal(lineItemRow,lineItemTotal);
    },
    ...
    calculateRetailDiscountForLineItem : function(lineItemRow) {
        var discountContianer = lineItemRow.find('div.retail_discountUI');
        var element = discountContianer.find('input.retail_discounts').filter(':checked');
        var discountType = element.data('discountType');
        var discountRow = element.closest('tr');
        ...
        jQuery('input.retail_discount_type',discountContianer).val(discountType);
        var rowPercentageField = jQuery('input.retail_discount_percentage',discountContianer);
        var rowAmountField = jQuery('input.retail_discount_amount',discountContianer);
        ...
        if(discountType == Inventory_Edit_Js.percentageDiscountType){
            rowPercentageField.removeClass('hide').focus();
            //since it is percentage
            var productTotal = this.getRetailLineItemTotal(lineItemRow);
            discountValue = (productTotal * discountValue)/100;
        }else if(discountType == Inventory_Edit_Js.directAmountDiscountType){
            rowAmountField.removeClass('hide').focus();
        }
        this.setRetailDiscountTotal(lineItemRow,discountValue)
            .calculateRetailTotalAfterDiscount(lineItemRow);
    },
    /**
    ...
    calculateRetailTotalAfterDiscount: function(lineItemRow) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var productTotal = this.getRetailLineItemTotal(lineItemRow);
        var discountTotal = this.getRetailDiscountTotal(lineItemRow);
        var totalAfterDiscount = productTotal - discountTotal;
        totalAfterDiscount = totalAfterDiscount.toFixed(numberOfDecimal);
        this.setRetailTotalAfterDiscount(lineItemRow,totalAfterDiscount);
    },
    ...
    calculateRetailTaxForLineItem : function(lineItemRow) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var totalAfterDiscount = this.getRetailTotalAfterDiscount(lineItemRow);
        var taxPercentages = jQuery('.retail_taxPercentage',lineItemRow);
        //intially make the tax as zero
        var taxTotal = 0;
        jQuery.each(taxPercentages,function(index,domElement){
            var taxPercentage = jQuery(domElement);
            ...
            jQuery('.retail_taxTotal',individualTaxRow).val(individualTaxTotal);
            taxTotal += parseFloat(individualTaxTotal);
        });
        taxTotal = parseFloat(taxTotal.toFixed(numberOfDecimal));
        this.setRetailLineItemTaxTotal(lineItemRow, taxTotal);
    },
    ...
    calculateRetailLineItemNetPrice : function(lineItemRow) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var totalAfterDiscount = this.getRetailTotalAfterDiscount(lineItemRow);
        var netPrice = parseFloat(totalAfterDiscount);
        if(this.isRetailIndividualTaxMode()) {
            var productTaxTotal = this.getRetailLineItemTaxTotal(lineItemRow);
            netPrice +=  parseFloat(productTaxTotal)
        }
        netPrice = netPrice.toFixed(numberOfDecimal);
        this.setRetailLineItemNetPrice(lineItemRow,netPrice);
    },
    ...
    calculateRetailNetTotal : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();
        var netTotalValue = 0;
        lineItemTable.find('tr.'+this.rowClass).each(function(index,domElement){
            var lineItemRow = jQuery(domElement);
            netTotalValue += thisInstance.getRetailLineItemNetPrice(lineItemRow);
        });
        this.setRetailNetTotal(netTotalValue);
    },
    ...
    calculateRetailFinalDiscount : function() {
        var thisInstance = this;
        var discountContainer = jQuery('#retail_finalDiscountUI');
        var element = discountContainer.find('input.retail_finalDiscounts').filter(':checked');
        var discountType = element.data('discountType');
        var discountRow = element.closest('tr');
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());

        jQuery('#retail_discount_type_final').val(discountType);
        var rowPercentageField = discountContainer.find('input.retail_discount_percentage_final');
        var rowAmountField = discountContainer.find('input.retail_discount_amount_final');
        ...
        if(discountType == Inventory_Edit_Js.percentageDiscountType){
            rowPercentageField.removeClass('hide').focus();
            //since it is percentage
            var productTotal = this.getRetailNetTotal();
            discountValue = (productTotal * discountValue)/100;
        }else if(discountType == Inventory_Edit_Js.directAmountDiscountType){
            if(thisInstance.prevSelectedCurrencyConversionRate){
                var conversionRate = jQuery('#conversion_rate').val();
                conversionRate = conversionRate / thisInstance.prevSelectedCurrencyConversionRate;
                discountValue = discountValue * conversionRate;
                discountRow.find('.retail_discountVal').val(discountValue);
            }
            rowAmountField.removeClass('hide').focus();
        }
        discountValue = parseFloat(discountValue).toFixed(numberOfDecimal);
        this.setRetailFinalDiscountTotal(discountValue);
        this.calculateRetailPreTaxTotal();
    },
    ...
    calculateRetailGroupTax : function() {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var netTotal = this.getRetailNetTotal();
        var finalDiscountValue = this.getRetailFinalDiscountTotal();
        var amount = netTotal - finalDiscountValue;
        amount = parseFloat(amount).toFixed(numberOfDecimal);
        var groupTaxContainer = jQuery('#retail_group_tax_div');
        var groupTaxTotal = 0;
        groupTaxContainer.find('.retail_groupTaxPercentage').each(function(index,domElement){
            var groupTaxPercentageElement = jQuery(domElement);
            var groupTaxRow = groupTaxPercentageElement.closest('tr');
            if(isNaN(groupTaxPercentageElement.val())){
                var groupTaxValue = "0.00";
            ...
            groupTaxValue = parseFloat(groupTaxValue).toFixed(numberOfDecimal);
            groupTaxRow.find('.retail_groupTaxTotal').val(groupTaxValue);
            groupTaxTotal += parseFloat(groupTaxValue);
        });
        this.setRetailGroupTaxTotal(groupTaxTotal);
    },
    ...
    calculateRetailShippingAndHandlingTaxCharges : function() {
        var shippingHandlingCharge = this.getRetailShippingAndHandling();
        var shippingTaxDiv = jQuery('#retail_shipping_handling_div');
        var shippingTaxPercentage = shippingTaxDiv.find('.retail_shippingTaxPercentage');
        ...
        jQuery.each(shippingTaxPercentage,function(index,domElement){
            ...
            jQuery('.retail_shippingTaxTotal',currentParentRow).val(currentTaxTotal);
        });
    },

    calculateActualDiscount : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();
        var totalValue = 0;
        lineItemTable.find('tr.'+this.rowClass).each(function(index,domElement){
            var lineItemRow = jQuery(domElement);
            totalValue += thisInstance.getLineItemTotal(lineItemRow);
        });
        var netTotal = this.getNetTotal();
        var finalDiscountTotal = this.getFinalDiscountTotal();
        var actualDiscountValue = (1-((netTotal-finalDiscountTotal)/totalValue))*100;
        this.setActualDiscount(actualDiscountValue);
    },

    calculateRetailActualDiscount : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();
        var totalValue = 0;
        lineItemTable.find('tr.'+this.rowClass).each(function(index,domElement){
            var lineItemRow = jQuery(domElement);
            totalValue += thisInstance.getRetailLineItemTotal(lineItemRow);
        });
        var netTotal = this.getRetailNetTotal();
        var finalDiscountTotal = this.getRetailFinalDiscountTotal();
        var actualDiscountValue = (1-((netTotal-finalDiscountTotal)/totalValue))*100;
        this.setRetailActualDiscount(actualDiscountValue);
    },

    calculateRetailActualMargin : function() {

        var whlTotal = this.getPreTaxTotal();
        var netTotal = this.getRetailNetTotal();
        var finalDiscountTotal = this.getRetailFinalDiscountTotal();
        var actualMarginValue = (1-whlTotal/(netTotal-finalDiscountTotal))*100;
        this.setRetailActualMargin(actualMarginValue);
    },
    ...
    calculateGrandTotal : function(){
        ...
        this.calculateActualDiscount();
    },

    calculateRetailGrandTotal : function(){
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var netTotal = this.getRetailNetTotal();
        var discountTotal = this.getRetailFinalDiscountTotal();
        var shippingHandlingCharge = this.getRetailShippingAndHandling();
        var shippingHandlingTax = this.getRetailShippingAndHandlingTaxTotal();
        var adjustment = this.getRetailAdjustmentValue();
        var grandTotal = parseFloat(netTotal) - parseFloat(discountTotal) + parseFloat(shippingHandlingCharge) + parseFloat(shippingHandlingTax);

        if(this.isRetailGroupTaxMode()){
            grandTotal +=  this.getRetailGroupTaxTotal();
        }

        if(this.isRetailAdjustMentAddType()) {
            grandTotal +=  parseFloat(adjustment);
        }else if(this.isRetailAdjustMentDeductType()) {
            grandTotal -=  parseFloat(adjustment);
        }

        grandTotal = grandTotal.toFixed(numberOfDecimal);
        this.setRetailGrandTotal(grandTotal);

        this.calculateRetailActualDiscount();
        this.calculateRetailActualMargin();
    },
    ...
    registerRetailFinalDiscountShowEvent : function(){
        var thisInstance = this;
        jQuery('#retail_finalDiscount').on('click',function(e){
            var finalDiscountUI = jQuery('#retail_finalDiscountUI');
            thisInstance.hideRetailLineItemPopup();
            finalDiscountUI.removeClass('hide');
        });
    },
    ...
    registerRetailFinalDiscountChangeEvent : function() {
        var lineItemResultTab = this.getRetailLineItemResultContainer();
        var thisInstance = this;

        lineItemResultTab.on('change','.retail_finalDiscounts',function(e){
            thisInstance.finalRetailDiscountChangeActions();
        });
    },
    ...
    registerRetailFinalDiscountValueChangeEvent : function(){
        var thisInstance = this;
        jQuery('.retail_finalDiscountSave').on('click',function(e){
            thisInstance.finalRetailDiscountChangeActions();
        });
    },
    ...
    registerRetailGroupTaxShowEvent : function() {
        var thisInstance = this;
        jQuery('#retail_finalTax').on('click',function(e){
            var groupTaxContainer = jQuery('#retail_group_tax_row');
            thisInstance.hideRetailLineItemPopup();
            groupTaxContainer.find('.retail_finalTaxUI').removeClass('hide');
        });
    },
    ...
    registerRetailGroupTaxChangeEvent : function() {
        var thisInstance = this;
        var groupTaxContainer = jQuery('#retail_group_tax_row');

        groupTaxContainer.on('focusout','.retail_groupTaxPercentage',function(e){
            thisInstance.calculateRetailGroupTax();
            thisInstance.calculateRetailGrandTotal();
        });
    },

    calculatePricesWithMargin : function () {
        ...
        lineItemTable.find('tr.'+this.rowClass).each(function(index,domElement){
            var lineItemRow = jQuery(domElement);
            thisInstance.lineItemRowRetailCalculations(lineItemRow);
        });
        this.lineItemToTalResultRetailCalculations();
    },

    registerMarginChange : function() {
        var thisInstance = this;
        this.getMarginElement().on('focusout', function(e){
            var value = jQuery(e.currentTarget).val();
            if(value == "") {
                jQuery(e.currentTarget).val("0.00");
            }
            thisInstance.calculatePricesWithMargin();
        });
    },
    ...
    registerRetailShippingAndHandlingChargesChange : function(){
        var thisInstance = this;
        this.getRetailShippingAndHandlingControlElement().on('focusout', function(e){
            var value = jQuery(e.currentTarget).val();
            if(value == ""){
                jQuery(e.currentTarget).val("0.00");
            }
            thisInstance.retailShippingAndHandlingChargesChangeActions();
        });
        jQuery('.retail_shippingTaxPercentage').on('change',function(){
            thisInstance.retailShippingAndHandlingChargesChangeActions();
        })
        jQuery('.retail_finalTaxSave').on('click',function(){
            thisInstance.setRetailShippingAndHandlingTaxTotal();
        })
    },
    ...
    registerRetailShippingAndHandlingTaxShowEvent : function(){
        var thisInstance = this;
        jQuery('#retail_shippingHandlingTax').on('click',function(e){
            var finalShippingHandlingDiv = jQuery('#retail_shipping_handling_div');
            thisInstance.hideRetailLineItemPopup();
            finalShippingHandlingDiv.removeClass('hide');
        });
    },
    ...
    registerRetailAdjustmentTypeChange : function() {
        var thisInstance = this;
        this.getRetailAdjustmentTypeElement().on('change', function(e){
            thisInstance.calculateRetailGrandTotal();
        });
    },
    ...
    registerRetailAdjustmentValueChange : function() {
        var thisInstance = this;
        this.getRetailAdjustmentTextElement().on('focusout',function(e){
            var value = jQuery(e.currentTarget).val();
            if(value == ""){
                jQuery(e.currentTarget).val("0.00");
            }
    ...
    lineItemRetailResultActions: function(){
        var thisInstance = this;
        var lineItemResultTab = this.getRetailLineItemResultContainer();

        this.registerRetailFinalDiscountShowEvent();
        this.registerRetailFinalDiscountValueChangeEvent();
        this.registerRetailFinalDiscountChangeEvent();

//        this.registerLineItemActionSaveEvent(); jinjinjin
//        this.registerLineItemsPopUpCancelClickEvent(); jin
        this.registerMarginChange();

        this.registerRetailGroupTaxShowEvent();
        this.registerRetailGroupTaxChangeEvent();

        this.registerRetailShippingAndHandlingChargesChange();
        this.registerRetailShippingAndHandlingTaxShowEvent();

        this.registerRetailAdjustmentTypeChange();
        this.registerRetailAdjustmentValueChange();
    ...
    lineItemRowRetailCalculations : function(lineItemRow) {
        this.calculateRetailLineItemTotal(lineItemRow);
        this.calculateRetailDiscountForLineItem(lineItemRow);
        this.calculateRetailTaxForLineItem(lineItemRow);
        this.calculateRetailLineItemNetPrice(lineItemRow);
    },
    ...
    lineItemToTalResultCalculations : function(){
        ...
        this.calculateWhlPrice();
        this.calculateRetailPrice();
//        this.lineItemToTalResultRetailCalculations();
    },

    lineItemToTalResultRetailCalculations : function(){
        this.calculateRetailNetTotal();
        this.calculateRetailFinalDiscount();
        if(this.isRetailGroupTaxMode()){
            this.calculateRetailGroupTax();
        }
        //this.calculateShippingAndHandlingTaxCharges();
        this.calculateRetailGrandTotal();
...
//        });
    ...
    calculateWhlPrice : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();
        lineItemTable.find('tr.'+this.rowClass).each(function(index,domElement){
            var lineItemRow = jQuery(domElement);
            thisInstance.calculateLineItemWhlPrice(lineItemRow);
        });
    },
    ...
    calculateRetailPrice : function() {
        ...
        lineItemTable.find('tr.'+this.rowClass).each(function(index,domElement){
            var lineItemRow = jQuery(domElement);
            thisInstance.calculateLineItemRetailPrice(lineItemRow);
        });
    },

    calculateLineItemWhlPrice : function(lineItemRow) {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var whlPrice = this.getLineItemNetPrice(lineItemRow)/this.getNetTotal()*this.getPreTaxTotal()/this.getQuantityValue(lineItemRow);
        whlPrice = whlPrice.toFixed(numberOfDecimal);
        this.setLineItemWhlPrice(lineItemRow,whlPrice);
    },

    calculateLineItemRetailPrice : function(lineItemRow) {

        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var retail_listprice = this.getLineItemWhlPrice(lineItemRow);
        var margin_value = this.getMarginValue();
        var margin = (100-margin_value)/100;
        retail_listprice = retail_listprice/margin;
        retail_listprice = retail_listprice.toFixed(numberOfDecimal);
        this.setRetailListPriceValue(lineItemRow, retail_listprice);
    },
    ...
    quantityChangeActions : function(lineItemRow) {
        ...
        this.lineItemRowRetailCalculations(lineItemRow);
        this.lineItemToTalResultRetailCalculations();
    },
    ...
    lineItemRetailDiscountChangeActions : function(lineItemRow){
        this.calculateRetailDiscountForLineItem(lineItemRow);
        this.calculateRetailTaxForLineItem(lineItemRow);
        this.calculateRetailLineItemNetPrice(lineItemRow);
    ...
    taxRetailPercentageChangeActions : function(lineItemRow){
        this.calculateRetailLineItemNetPrice(lineItemRow);
        this.calculateRetailNetTotal();
        this.calculateRetailFinalDiscount();
        if(this.isRetailGroupTaxMode()){
    ...
    retailShippingAndHandlingChargesChangeActions : function(){
        this.calculateRetailShippingAndHandlingTaxCharges();
        this.setRetailShippingAndHandlingTaxTotal();
        this.calculateRetailPreTaxTotal();
        this.calculateRetailGrandTotal();
    },
    ...
    finalRetailDiscountChangeActions : function() {
        this.calculateRetailFinalDiscount();
        if(this.isRetailGroupTaxMode()){
            this.calculateRetailGroupTax();
        }
    ...
    registerRetailDisountChangeEvent : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();
        lineItemTable.on('change','.retail_discounts',function(e){
            var lineItemRow = jQuery(e.currentTarget).closest('tr.'+thisInstance.rowClass);
            thisInstance.lineItemRetailDiscountChangeActions(lineItemRow);
        });
    },
    /**
    ...
    registerRetailDisountValueChange : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();
        lineItemTable.on('click','.retail_discountSave', function(e){
            var element = jQuery(e.currentTarget);
            //if the element is not hidden then we need to handle the focus out
            if(!app.isHidden(element)){
                var lineItemRow = jQuery(e.currentTarget).closest('tr.'+thisInstance.rowClass);
    ...
    hideRetailLineItemPopup : function(){
        var editForm = this.getForm();
        var popUpElementContainer = jQuery('.retailpopupTable',editForm).closest('div');
        if(popUpElementContainer.length > 0){
            popUpElementContainer.addClass('hide');
        }
    },
    ...
    registerRetailLineItemDiscountShowEvent : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();

        lineItemTable.on('click','.retail_individualDiscount',function(e){
            var element = jQuery(e.currentTarget);
            var response = thisInstance.isProductSelected(element);
            if(response == true){
                return;
            ...
            var parentElem = jQuery(e.currentTarget).closest('td');
            thisInstance.hideRetailLineItemPopup();
            parentElem.find('div.retail_discountUI').removeClass('hide');
        });
    },
    ...
    registerProductAndServicePopup : function() {
        ...
        lineItemTable.on('click','.productName', function(e){
            var element = jQuery(e.currentTarget);
            thisInstance.lineItemPopupEventHandler(element).then(function(data){
                var parent = element.closest('tr');
                var deletedItemInfo = parent.find('.deletedItem');
    ...
    registerRetailListPriceChangeEvent : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();

        lineItemTable.on('focusout', 'input.retail_listPrice',function(e){
            var element = jQuery(e.currentTarget);
            var lineItemRow = thisInstance.getClosestLineItemRow(element);
//			thisInstance.quantityChangeActions(lineItemRow);
            thisInstance.lineItemRowRetailCalculations(lineItemRow);
            thisInstance.lineItemToTalResultRetailCalculations();
        });
    },
    ...
    registerRetailTaxPercentageChange : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();

        lineItemTable.on('focusout','.retail_taxPercentage',function(e){
            var element = jQuery(e.currentTarget);
            var lineItemRow = thisInstance.getClosestLineItemRow(element);
            thisInstance.calculateRetailTaxForLineItem(lineItemRow);
        });

        lineItemTable.on('click','.retail_taxSave',function(e){
            var element = jQuery(e.currentTarget);
            var lineItemRow = thisInstance.getClosestLineItemRow(element);
            thisInstance.taxRetailPercentageChangeActions(lineItemRow);
        });
    },
    ...
    registerRetailLineItemTaxShowEvent : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();

        lineItemTable.on('click','.retail_individualTax',function(e){
            var element = jQuery(e.currentTarget);
            var response = thisInstance.isProductSelected(element);
            if(response == true){
                return;
            ...
            var parentElem = jQuery(e.currentTarget).closest('td');
            thisInstance.hideRetailLineItemPopup()
            parentElem.find('.retail_taxUI').removeClass('hide');
        });
    },
    ...
    registerRetailTaxTypeChange : function() {
        var thisInstance = this;
        var lineItemTable = this.getLineItemContentsContainer();

        this.getRetailTaxTypeSelectElement().on('change', function(e){
            if(thisInstance.isRetailIndividualTaxMode()) {
                jQuery('#retail_group_tax_row').addClass('hide');
                lineItemTable.find('tr.'+thisInstance.rowClass).each(function(index,domElement){
                    var lineItemRow = jQuery(domElement);
                    lineItemRow.find('.retail_individualTaxContainer,.retail_productTaxTotal').removeClass('hide');
                    thisInstance.lineItemRowRetailCalculations(lineItemRow);
                });
            }else{
                jQuery('#retail_group_tax_row').removeClass('hide');
                lineItemTable.find('tr.'+thisInstance.rowClass).each(function(index,domElement){
                    var lineItemRow = jQuery(domElement);
                    lineItemRow.find('.retail_individualTaxContainer,.retail_productTaxTotal').addClass('hide');
                    thisInstance.calculateRetailLineItemNetPrice(lineItemRow);
                });
            }
            thisInstance.lineItemToTalResultRetailCalculations();
        });
    ...
    AdjustmentRetailShippingResultCalculation: function(conversionRate){
        //Adjustment
        var thisInstance = this;
        var adjustmentElement = thisInstance.getRetailAdjustmentTextElement();
        var newAdjustment = jQuery(adjustmentElement).val() * conversionRate;
        jQuery(adjustmentElement).val(newAdjustment);

        //Shipping & handling
        var shippingHandlingElement = thisInstance.getRetailShippingAndHandlingControlElement();
        var resultVal = jQuery(shippingHandlingElement).val() * conversionRate;
        jQuery(shippingHandlingElement).val(resultVal);
        jQuery(shippingHandlingElement).trigger('focusout');
    },
    ...
    LineItemRetailDirectDiscountCal: function(conversionRate){
        //LineItems Discount Calculations for direct Price reduction
        var thisInstance = this;
        ...
        jQuery(lineItemRows).each(function(index) {
            ...
            if((discountType == Inventory_Edit_Js.directAmountDiscountType) ){
                var newdiscountValue = conversionRate * discountValue;
                discountRow.find('.retail_discountVal').val(newdiscountValue);
                jQuery(element).closest('tr').find('.retail_discountVal').val(newdiscountValue);
                thisInstance.setRetailDiscountTotal(lineItemRow,newdiscountValue);
            }
        });
    },
    ...
    lineItemActions: function() {
        ...
        this.registerRetailDisountChangeEvent();
        this.registerRetailDisountValueChange();
        this.registerRetailLineItemDiscountShowEvent();
...
//        this.registerQuantityChangeEventHandler();
        this.registerRetailListPriceChangeEvent();

        this.registerRetailTaxPercentageChange();
        this.registerRetailLineItemTaxShowEvent();

//        this.registerDeleteLineItemEvent();
        this.registerRetailTaxTypeChange();
//        this.registerCurrencyChangeEvent();
    ...
    updateLineItemsElementWithSequenceNumber : function(lineItemRow,expectedSequenceNumber , currentSequenceNumber){
        ...
        var idFields = new Array('productName','subproduct_ids','hdnProductId',
            'comment','qty','productwidth','productdrop','fabric','fabric_description','location',
            'controltype','rolldirection','bottomrail','railcolour','controlside','controlcolour',
            'chaincolour','chainlength','springassist','bracketcovers','railroad','comments',
            'listPrice','discount_type','discount_percentage',
            'discount_amount','lineItemType','searchIcon','netPrice','subprod_names',
            'productTotal','discountTotal','totalAfterDiscount','taxTotal', 'wholesalePrice', 'retail_listPrice',
            'retail_discount_type','retail_discount_percentage',
            'retail_discount_amount','retail_netPrice',
            'retail_productTotal','retail_discountTotal','retail_totalAfterDiscount','retail_taxTotal');
    ...
    saveRetailProductCount : function () {
        jQuery('#retail_totalProductCount').val(jQuery('tr.'+this.rowClass, this.getLineItemContentsContainer()).length);
    },
    ...
    saveRetailSubTotalValue : function() {
        jQuery('#retail_subtotal').val(this.getRetailNetTotal());
    },
    ...
    saveRetailTotalValue : function() {
        jQuery('#retail_total').val(this.getRetailGrandTotal());
    },
    ...
    registerSubmitEvent : function () {
        ...
        editViewForm.submit(function(e){
            ...
            var lineItemTable = thisInstance.getLineItemContentsContainer();
            jQuery('.retail_discountSave',lineItemTable).trigger('click');
            thisInstance.lineItemToTalResultRetailCalculations();
            thisInstance.saveRetailProductCount();
            thisInstance.saveRetailSubTotalValue();
            thisInstance.saveRetailTotalValue();
            thisInstance.saveRetailPreTaxTotalValue();
    ...
    registerReferenceSelectionEvent : function(container) {
        ...
        //added by Jin
        jQuery('input[name="carrier"]', container).on(Vtiger_Edit_Js.referenceSelectionEvent, function(e, data){
            thisInstance.referenceCarrierSelectionEventHandler(data, container);
        });
    },

    referenceCarrierSelectionEventHandler : function(data, container) {
        var thisInstance = this;
...
//                alert(phone+":"+website);
                jQuery('#Quotes_editView_fieldName_cf_816').val(phone);
                jQuery('#Quotes_editView_fieldName_cf_812').val(website);

                jQuery('#SalesOrder_editView_fieldName_cf_840').val(phone);
                jQuery('#SalesOrder_editView_fieldName_cf_836').val(website);
...
//                alert(phone+":"+mobile+":"+email);
                jQuery('#Quotes_editView_fieldName_cf_796').val(phone);
                jQuery('#Quotes_editView_fieldName_cf_798').val(email);
                jQuery('#Quotes_editView_fieldName_cf_800').val(mobile);

                jQuery('#SalesOrder_editView_fieldName_cf_824').val(phone);
                jQuery('#SalesOrder_editView_fieldName_cf_826').val(email);
                jQuery('#SalesOrder_editView_fieldName_cf_828').val(mobile);
            },
            function(error, err){
    ...
    setRetailPreTaxTotal : function(preTaxTotalValue){
        jQuery('#retail_preTaxTotal').text(preTaxTotalValue);
        return this;
    },
    ...
    getRetailPreTaxTotal : function() {
        return parseFloat(jQuery('#retail_preTaxTotal').text());
    },

    getTaxPercentage : function () {
        return parseFloat(jQuery('#tax_percentage').text());
    },

    getRetailTaxPercentage : function () {
        return parseFloat(jQuery('#retail_tax_percentage').text());
    },
    ...
    calculatePreTaxTotal : function() {
        ...
        var taxTotal = preTaxTotalValue/this.getTaxPercentage();
        taxTotal = parseFloat(taxTotal).toFixed(numberOfDecimal);
        this.setShowGroupTaxTotal(taxTotal);
    },

    calculateRetailPreTaxTotal : function() {
        var numberOfDecimal = parseInt(jQuery('.numberOfCurrencyDecimal').val());
        var netTotal = this.getRetailNetTotal();
        var shippingHandlingCharge = this.getRetailShippingAndHandling();
        var finalDiscountValue = this.getRetailFinalDiscountTotal();
        var preTaxTotal = netTotal+shippingHandlingCharge-finalDiscountValue;
        var preTaxTotalValue = parseFloat(preTaxTotal).toFixed(numberOfDecimal);
        this.setRetailPreTaxTotal(preTaxTotalValue);

        var taxTotal = preTaxTotalValue/this.getRetailTaxPercentage();
        taxTotal = parseFloat(taxTotal).toFixed(numberOfDecimal);
        this.setRetailShowGroupTaxTotal(taxTotal);
    },
    /**
    ...
    saveRetailPreTaxTotalValue : function() {
        jQuery('#retail_pre_tax_total').val(this.getRetailPreTaxTotal());
    },
    ...
    registerEvents: function(){
        ...
        this.lineItemRetailResultActions();
