...
{strip}
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        ...
        <tr>
            ...
            <td class="hide"><b>{vtranslate('LBL_LIST_PRICE',$MODULE)}</b></td>
            <td class="hide"><b class="pull-right">{vtranslate('LBL_ITEM_DISCOUNT',$MODULE)}</b></td>
            <td class="hide"><b class="pull-right">{vtranslate('LBL_NET_PRICE',$MODULE)}</b></td>
        ...
        <tr id="row0" class="hide lineItemCloneCopy">
            {include file="LineItemsContentRetail.tpl"|@vtemplate_path:'Inventory' row_no=0 data=[]}
        </tr>
        {foreach key=row_no item=data from=$RELATED_PRODUCTS}
            <tr id="row{$row_no}" class="lineItemRow" {if $data["entityType$row_no"] eq 'Products'}data-quantity-in-stock={$data["qtyInStock$row_no"]}{/if}>
                {include file="LineItemsContentRetail.tpl"|@vtemplate_path:'Inventory' row_no=$row_no data=$data}
            </tr>
        {/foreach}
        {if count($RELATED_PRODUCTS) eq 0}
            <tr id="row1" class="lineItemRow">
                {include file="LineItemsContentRetail.tpl"|@vtemplate_path:'Inventory' row_no=1 data=[]}
            </tr>
        {/if}
    ...
    <table class="table table-bordered blockContainer lineItemTable hide" id="lineItemResult">
        <tr>
            <td  width="83%">
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="retail_lineItemResult">
        ...
        <tr>
            <td width="83%">
                <span class="pull-right">(-)&nbsp;<b><a href="javascript:void(0)"  id="retail_finalDiscount">{vtranslate('LBL_INVOICE_DISCOUNT',$MODULE)}</a></b></span>
            </td>
            <td>
        ...
        <tr id="retail_group_tax_row" valign="top" class="{if $IS_INDIVIDUAL_TAX_TYPE}hide{/if}">
            <td width="83%">
                ...
                <span class="pull-right">(+)&nbsp;<b><!--a href="javascript:void(0)" id="retail_finalTax"-->{vtranslate('LBL_GST',$MODULE)}<!--/a--></b></span>
                <!-- Pop Div For Group TAX -->
        ...
        <tr class="hide">
            <td width="83%">
                <span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="retail_shippingHandlingTax">{vtranslate('LBL_TAX_FOR_SHIPPING_AND_HANDLING',$MODULE)} </a></b></span>
