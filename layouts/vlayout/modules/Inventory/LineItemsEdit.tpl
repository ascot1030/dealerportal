...
{strip}
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        <tr>
        {if 1}
            <th colspan="11"><span class="inventoryLineItemHeader">{vtranslate('LBL_ITEM_DETAILS', $MODULE)}</span></th>
        ...
        <tr>
            ...
            <td class="hide"><b class="pull-right">{vtranslate('LBL_RETAIL_LIST_PRICE',$MODULE)}</b></td>
            <td class="hide"><b class="pull-right">{vtranslate('LBL_ITEM_DISCOUNT',$MODULE)}</b></td>
            <td class="hide"><b class="pull-right">{vtranslate('LBL_RETAIL_NET_PRICE',$MODULE)}</b></td>
        </tr>
    ...
    <table class="table table-bordered blockContainer lineItemTable hide" id="retail_lineItemResult">
        <tr>
            <td  width="83%">
                <div class="pull-right"><strong>{vtranslate('LBL_ITEMS_TOTAL',$MODULE)}</strong></div>
            </td>
