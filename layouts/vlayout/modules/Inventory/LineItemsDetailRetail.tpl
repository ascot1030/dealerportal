...
<table class="table table-bordered mergeTables">
    <thead>
    {if 1}
    <th colspan="8" class="detailViewBlockHeader">
	...
	<tr class="listViewBlinds" data-record="{$RECORDID}" data-id="{$INDEX}">
		...
		<div>
		    <span class="pull-right">
		    {$LINE_ITEM_DETAIL["retail_listPrice$INDEX"]}
		    </span>
		</div>
		{if $LAYOUT}
		<div>
        ...
        <tr>
            <td>
                <b>{vtranslate('LBL_TOTAL_QTY',$MODULE_NAME)}</b>
            </td>
            <td>
                <b>{$FINAL_DETAILS["totalqty"]}</b>
            </td>
            <td colspan="7">
            </td>
            <td>
        ...
        <tr>
            <td colspan="2">
                <b>{vtranslate('LBL_TAX_RATE',$MODULE_NAME)}</b>
            </td>
            <td>
                <b>{$FINAL_DETAILS["retail_taxes"][0]["percentage"]*1000/1000}%</b>
            </td>
            <td colspan="6">
                <span class="pull-right">
                <b>{vtranslate('LBL_GST', $MODULE_NAME)} </b>
                </span>
            </td>
            <td>
                <span class="pull-right">
