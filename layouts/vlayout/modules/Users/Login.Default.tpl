...
<html>
	...
	<body>
		<div class="container">
		    <div align="center" class="customarea">
                <div class="login-box" id="loginDiv">
                    <div>
                        <h3 class="login-header">Login to Dealer Portal</h3>
                    </div>
					...
					<div class="row-fluid">
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2014-{date('Y')}&nbsp;Suntex Pty Ltd. All rights reserved.</small>
							</div>
						</div>
						<div class="span6 pull-right" >
							<div class="pull-right footer-icons">
								<small>{vtranslate('LBL_CONNECT_WITH_US', $MODULE)}&nbsp;</small>
								<a href="https://www.facebook.com/SuntexAustralia"><img src="layouts/vlayout/skins/images/facebook.png"></a>
								&nbsp;<a href="https://twitter.com/suntex"><img src="layouts/vlayout/skins/images/twitter.png"></a>
								&nbsp;<a href="https://www.linkedin.com/company/suntex-pty-ltd"><img src="layouts/vlayout/skins/images/linkedin.png"></a>
								&nbsp;<a href="http://www.youtube.com/user/suntex"><img src="layouts/vlayout/skins/images/youtube.png"></a>
							</div>
						</div>
					</div>   
				</div>    
