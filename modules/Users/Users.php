...
//        $this->db->startTransaction();
    ...
    function retrive_user_roleid($user_id) {
        global $adb;
    ...
    function retrive_depth($roleid) {
        global $adb;
        $query = "SELECT depth FROM vtiger_role where roleid=?";
        $result  =$adb->pquery($query, array($roleid));
        $depth = $adb->query_result($result,0,'depth');
        return $depth;
    }
