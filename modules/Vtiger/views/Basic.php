...
abstract class Vtiger_Basic_View extends Vtiger_Footer_View {
	...
	function preProcess (Vtiger_Request $request, $display=true) {
        ...
        $viewer->assign('SESSION_USERID', $_SESSION['authenticated_user_id']);
        $viewer->assign('SESSION_ROLEID', $_SESSION['roleid']);
        $viewer->assign('SESSION_DEPTH', $_SESSION['depth']);
        $viewer->assign('SESSION_USERNAME', $_SESSION['username']);
