...
//        $sql = "SELECT templateid, module FROM vtiger_pdfmaker GROUP BY module";
        $sql = "SELECT templateid, module FROM vtiger_pdfmaker where deleted=0";
    ...
    public function GetPreparedMPDF(&$mpdf, $record, $module, $language, $purchase) {
        ...
        $PDFContent = $this->GetPDFContentRef($module, $focus, $language, $purchase);
    ...
    public function GetPDFContentRef($module, $focus, $language, $purchase) {
        //require_once("modules/PDFMaker/InventoryPDF.php");

        //added by Jin

        if($module=="Quotes") {
            $sql = "update vtiger_pdfmaker set module ='Quotes1' where templateid=7 OR templateid=8";
            $this->db->pquery($sql);

            $sql = "update vtiger_pdfmaker set module ='Quotes' where templateid =?";
            ...
            $sql = "update vtiger_pdfmaker set module ='SalesOrder1' where templateid=3 OR templateid=4 OR templateid=9";
            $this->db->pquery($sql);

            $sql = "update vtiger_pdfmaker set module ='SalesOrder' where templateid =?";
            $depth = $_SESSION["depth"];
